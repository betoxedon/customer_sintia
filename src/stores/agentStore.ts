...
const { VITE_BASE_URL_SCRIPT } = import.meta.env
...
export const useAgentStore = defineStore('agent', () => {
   ...
   const agentScript = computed(() => {
      return `<start-sintia agentId='${agentActive.value.docId}'></start-sintia> <script src='${VITE_BASE_URL_SCRIPT}/script.js' defer></script>`
   })
